          ...
          <section className="rounded-2xl border border-white/10 bg-slate-900/60 p-8 backdrop-blur-md">
            ...
            <div className="space-y-10">
              {publishedSections.map((section, index) => {
                ...
                return (
                  <article key={section.id} className="overflow-hidden border-t border-white/10 pt-6 first:border-t-0 first:pt-0">
                    ...
                    {beforeParas.map((paragraph, i) => (
                      <p key={`pre-${i}`} className="mb-4 text-base leading-relaxed text-white/80">
                        {paragraph}
                      </p>
                    ))}
                    ...
                    {afterParas.map((paragraph, i) => (
                      <p key={`post-${i}`} className="mb-4 text-base leading-relaxed text-white/80">
                        {paragraph}
                      </p>
                    ))}
