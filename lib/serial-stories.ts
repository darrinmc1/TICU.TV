...
He didn't look back at Mira. He was afraid if he did he would stay, and staying felt like the wrong kind of cowardice.`,
            ...
            {
                slug: "chapter-10-road-to-the-plateau",
                chapterNumber: 10,
                title: "Road to the Plateau",
                label: "Chapter 10",
                shortDescription:
                    "With Millbrook behind them and Depthspire ahead, the survivors take to the road. The landscape changes, the scale pulls north, and the creatures of the wild grow stranger with every mile.",
                opening:
                    "They leave the walls at dawn, walking north into country that grows darker and colder with every league. The plateau waits on the horizon like something that has always been there, patient as geology.",
                status: "published",
                sections: [
                    {
                        id: "act-1",
                        title: "Act I: Leaving Walls",
                        summary: "The party departs Millbrook, carrying the weight of what they've lost and what lies ahead.",
                        isPublished: true,
                    },
                    {
                        id: "act-2",
                        title: "Act II: The Hedge and the Hounds",
                        summary: "Shadow-creatures hunt them across open country, forcing a running fight.",
                        isPublished: true,
                    },
                    {
                        id: "act-3",
                        title: "Act III: Waystone",
            ...
            {
                slug: "chapter-11-before-the-boundary",
                chapterNumber: 11,
                title: "Before the Boundary",
                label: "Chapter 11",
                shortDescription:
                    "The final approach to Depthspire brings ambush, sacrifice, and the crossing of a bridge that was built to be crossed only once. What waits beyond is older than the Concord itself.",
                opening:
                    "The ironwood gives way to basalt. The road narrows. The scale in Caelin's arm has been warm since they crossed into this country, pointing north with the quiet insistence of something that knows exactly where it is going.",
                status: "published",
                sections: [
                    {
                        id: "act-1",
                        title: "Act I: Ironwood Leaving, Road Returning",
                        summary: "The landscape transforms as they enter the Depthspire's domain.",
                        isPublished: true,
                    },
                    {
                        id: "act-2",
                        title: "Act II: The Market Road Ambush",
                        summary: "An ambush on the old trade road tests their resolve and costs them dearly.",
                        isPublished: true,
                    },
                    {
                        id: "act-3",
                        title: "Act III: The Boundary Bridge",
                        summary: "They cross the bridge that marks the point of no return, and Depthspire waits beyond.",
                        isPublished: true,
                    },
                ],
            },
